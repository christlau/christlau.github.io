...
const Contact = ({ data }) => {
  ...
  const { title, buttonText, buttonText2 } = frontmatter;
  ...
  return (
    <StyledContainer id="contact" ref={revealContainer}>
      ...
      <StyledEmailLink href={`https://www.linkedin.com/in/laurentianchris/`} target="_blank" rel="nofollow noopener noreferrer">
        {buttonText2}
      </StyledEmailLink>
    </StyledContainer>
  );
